#!/usr/bin/env python3
"""
Filter YouTube Comments with Qwen3.5-35B-A3B-Base via vLLM
Reads combined_data.jsonl, scores comments based on criteria using Qwen,
...
def main():
    parser = argparse.ArgumentParser(description="Filter comments using Qwen3.5-35B-A3B-Base via vLLM")
    parser.add_argument("--input", "-i", default="comment_results/combined_data.jsonl", help="Input JSONL file")
    parser.add_argument("--output", "-o", default="comment_results/filtered_comments_qwen.jsonl", help="Output JSONL file")
    parser.add_argument("--host", default="http://localhost:8000/v1", help="vLLM API Base URL")
    parser.add_argument("--model", default="Qwen/Qwen3.5-35B-A3B-Base", help="Model name")
            ...
            while retry_count < max_retries:
                try:
                    ...
                    try:
                        ...
                        print(f"  ??Failed to parse TSV response from Qwen: {e}")
